...
public class Card {
    ...
    private static void map(int card, String name, String shortName) {
    ...
    static {
        ...
        map(1401015, "无懈可击", "无懈");
        map(1413015, "无懈可击", "无懈");
        map(1301016, "诸葛连弩1", "连弩1");
        map(1201016, "诸葛连弩1", "连弩1");
        map(1102017, "雌雄双股2", "雌雄2");
        map(1102018, "寒冰剑2", "寒冰2");
        map(1106019, "青釭剑2", "青釭2");
        map(1105020, "青龙偃月刀3", "青龙3");
        map(1112021, "丈八蛇矛3", "丈八3");
        map(1305022, "贯石斧3", "贯石3");
        map(1312023, "方天画戟4", "方天4");
        map(1405024, "麒麟弓5", "麒麟5");
        map(1202025, "八卦阵", "八卦");
        map(1102025, "八卦阵", "八卦");
        map(1202026, "仁王盾", "仁王");
        map(1413027, "的卢+1", "马+1");
        map(1205028, "绝影+1", "马+1");
        map(1105029, "爪黄飞电+1", "马+1");
        map(1405030, "赤兔-1", "马-1");
        map(1313031, "大宛-1", "马-1");
        map(1113032, "紫骍-1", "马-1");
